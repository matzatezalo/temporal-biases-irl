...
def generate_trajectory(world, policy, start, final, distribution):
    """
    ...
    laststate = lasttraj[-1]
    distribution.append(laststate)

    return Trajectory(trajectory)


def generate_trajectory2(world, policy, start, final):
    """
    Generate a single trajectory.
...
def generate_trajectories(n, world, policy, start, final, distribution):
    """
    ...
    def _generate_one():
        ...
        return generate_trajectory(world, policy, s, final, distribution)
