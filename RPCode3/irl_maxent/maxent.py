...
def compute_expected_causal_svf(p_transition, p_initial, terminal, reward, discount,
    ...
    return expected_svf_from_policy(p_transition, p_initial, terminal, p_action, eps_svf), p_action
...
def irl_causal(p_transition, features, terminal, trajectories, optim, init, discount,
    ...
    # Create an empty list to store the final states
    final_states = []
    ...
    while delta > eps:
        ...
        e_svf, policyEnt = compute_expected_causal_svf(p_transition, p_initial, terminal, reward, discount,
                                            eps_lap, eps_svf)
    ...
    return features.dot(theta), features.T.dot(e_svf), policyEnt
